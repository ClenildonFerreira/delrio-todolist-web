...
export class TodoService {
  ...
  listTodos(page = 0, size = 10): Observable<PagedResponse<TodoDTO>> {
    ...
    return this.http.get<PagedResponse<TodoDTO>>(this.baseUrl, { params });
  }
  ...
  createTodo(todo: Partial<TodoDTO>) {
    ...
    return this.http.post<TodoDTO>(this.baseUrl, payload);
  }

  patchTodo(id: number, body: Partial<TodoDTO>) {
    return this.http.patch<TodoDTO>(`${this.baseUrl}/${id}`, body);
  }
